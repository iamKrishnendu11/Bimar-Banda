...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    { icon: Instagram, href: 'https://www.instagram.com/__algo.rhythm__', label: 'Instagram' },
    { icon: Linkedin, href: 'https://www.linkedin.com/company/algo-rhythm006/', label: 'LinkedIn' }
  ];
